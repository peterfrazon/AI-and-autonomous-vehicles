...
if __name__ == "__main__":
    # Define reference track (e.g., a lane change or slalom course)
    ref_x = np.linspace(0, 100, 200)
    ref_y = 5.0 * np.sin(ref_x / 10.0)

    # Benchmark both implemented controllers
    ...
    # Print Quantitative Descriptive Statistics (Required for passing grade)
    ...
    plt.plot(pp_x, pp_y, label="Pure Pursuit Trajectory")
    plt.plot(st_x, st_y, label="Stanley Trajectory")
